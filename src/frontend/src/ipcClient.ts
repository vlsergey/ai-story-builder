...
export const ipcClient = {
  ...
  planGraph: {
    ...
    startReview: (id: number, options?: { prompt?: string; content?: string }) => invoke<{ ok: boolean }>('plan:graph:node:start-review', id, options),
    acceptReview: (id: number) => invoke<{ ok: boolean }>('plan:graph:node:accept-review', id),

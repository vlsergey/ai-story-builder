    ...
    <UIContextMenuContent>
      ...
      <ContextMenuGroup>
          ...
          <ContextMenuSub>
            ...
            <ContextMenuSubContent>
              { contextMenuNode?.parent_id != null &&
                <ContextMenuItem key="null" onSelect={() => { moveNode(contextMenuNodeId, null) }}>
              ...
              {serverNodes
                ...
                .map(n => (
                  <ContextMenuItem key={n.id} onSelect={() => { moveNode(contextMenuNodeId, n.id) }}>
        ...
        {nodeDef?.canDelete && (
          <ContextMenuItem
            variant="destructive"
            onSelect={() => { deleteNode(contextMenuNodeId); }}
          >
            <TrashIcon />

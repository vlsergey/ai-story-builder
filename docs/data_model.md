...
- `lore_versions`
  ...
  - `source` TEXT NOT NULL DEFAULT 'manual'   -- 'manual' (user edited) | 'ai' (generated by AI)
  - `prompt` TEXT NULL — the AI prompt/instruction used when `source='ai'`; NULL for manual versions
  - `response_id` TEXT NULL — the AI engine response ID when `source='ai'`; NULL for manual versions
  - `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP
